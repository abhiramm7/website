...
{\footnotesize I build cyber-physical systems that create robust, equitable, and sustainable urban water infrastructure that thrives in the face of climate uncertainty.}

\vfill\eject

{\scriptsize {\noindent
{\faEnvelope\hspace{0.5em}{\href{mailto:abhiramm@umich.edu}{abhiramm@umich.edu}}}\\
{\faHome\hspace{0.5em}{\href{https://randomstorms.net}{randomstorms.net}}}\\
{\faGithub\hspace{0.5em}{\href{https://github.com/abhiramm7}{abhiramm7}}}\\}}
\end{vwcol}
...
\years{2025--}
\noindent\textbf{Lead Data Scientist} at Inframark\\[0.1cm]
...
\years{2023--2025}
\noindent\textbf{Senior Data Scientist} at Xylem\\[0.1cm]
Designed and implemented end-to-end machine learning-based solutions that inform decision-making in urban water infrastructure systems.
\vspace{2mm}
...
\begin{itemize}
	...
	\item  Led the development of statistical and machine learning-based methodologies for time-series filtering and anomaly detection for predictive maintenance and operational decision-making.
	\item  Developed a Flyte-based MLOps platform to streamline end-to-end machine learning model development, deployment, and maintenance for Xylem's digital water products.
\end{itemize}

\vspace{2mm}

\years{2020--2023}
\noindent\textbf{Hydraulic Control and Optimization Engineer} at Xylem\\[0.1cm]
...
\years{2013, 2015}
Academic Excellence, Amrita Vishwa Vidyapeetham
...
Co-organized and led a three day workshop on the use of open-storm's sensing stack
...
\item \textbf{Cloud Computing}: Experienced with cloud computing services (AWS, Google Cloud, and Azure) for creating backend systems.
